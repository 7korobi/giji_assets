...
(function() {
  var build, iframe_handler, type, typeof_str;
  ...
  this.Submit = {
    ...
    iframe: function(url, params) {
      var auto_load, auto_submit, deferred;
      deferred = m.deferred();
      auto_submit = {
      ...
      m.startComputation();
      m.render(iframe_handler, m('iframe', auto_load), m('form#submit_request', auto_submit, build("", params, function(key, val) {
        return m('input', {
          type: "hidden",
          name: key,
          value: val
...
},{"_ext":11,"bounce.js":2,"delay.yml":1,"form":12,"gui":13,"gui_animate":14,"gui_form":15,"gui_url":16,"headjs/dist/1.0.0/head":3,"lodash":4,"memory-record":6,"menu_tree":17,"mithril":8,"mithril-giji":7,"serialized-property":9,"timer":18}],11:[function(require,module,exports){
(function(){
...
},{"gui":13}],15:[function(require,module,exports){
(function() {
  var GUI;
...
},{"gui":13}],16:[function(require,module,exports){
(function(){
  var getter_setter, do_define, Url, out$ = typeof exports != 'undefined' && exports || this, toString$ = {}.toString;
  getter_setter = {
