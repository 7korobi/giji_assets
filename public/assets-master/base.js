...
module.exports = {"largo":10000,"grave":25000,"msg_delete":25000,"msg_minute":60000,"presto":50,"animato":200,"andante":800,"lento":3200};
...
},{"_ext":10,"base":11,"bounce.js":2,"conf_input":12,"conf_store":13,"delay.yml":1,"gui":14,"gui_animate":15,"gui_form":16,"headjs/dist/1.0.0/head":3,"input":17,"lodash":4,"memory-record":5,"mithril":8,"mithril-canvas":6,"mithril-giji":7,"submit":18,"timer":20,"url_store":21,"web_store":22}],10:[function(require,module,exports){
(function(){
  ...
  defines(String, {
    ...
    deco_text_lf: {
      get: function(){
        return br(space(player(anchor(link(random(this))))));
      }
    },
    line_text: {
      get: function(){
...
(function() {
  ...
  btn = function(style, check, store_base, load, key) {
    var cb, class_name, store;
    if (style["class"] == null) {
      style["class"] = 'edge';
    }
    store = store_base;
  ...
  this.Btn = {
    ...
    keys_reset: function(style, prop, val) {
      ...
      setter = function(key) {
        if (!keys_eq(prop, val)) {
          return prop(Mem.unpack.Keys(val));
        }
      };
...
},{"./input":17,"memory-record":5}],13:[function(require,module,exports){
(function() {
  var Mem, WebStore;
...
},{"./web_store":22,"memory-record":5}],14:[function(require,module,exports){
(function() {
  ...
  ids_sort = function(list, cb) {
    var hash, i, j, key, len, len1, order, results;
    hash = {};
    for (i = 0, len = list.length; i < len; i++) {
      key = list[i];
      hash[key] || (hash[key] = 0);
  ...
  GUI = {
    ...
    attrs_to: function(parent, query, base_attrs, cb) {
      var attr, attr_cb, data, elem, func, i, key, len, ref, ref1, results, tag, vdom;
      vdom = m(query);
      tag = vdom.tag;
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        elem = ref[i];
        data = attr && Mem.unpack.Array((ref1 = elem.attributes[attr]) != null ? ref1.value : void 0);
...
(function() {
  ...
  submit = function(props, f) {
    var cb;
    cb = function() {
      return form.delegate.submit(props, f);
    };
    return {
      onmouseup: cb,
      ontouchend: cb
  ...
  form = {
    ...
    entry: function(f, props) {
      return m("form[name=entry_form]", m("table." + f.mestype + ".talk", {
        key: f._id
      }, m("tr", m("th", GUI.portrate(f.chr_job.face_id)), m("td", m(".msg", m("p", m("label.medium[for=entry_pwd]", "参加パスワード"), m("input#entry_pwd[type=password][maxlength=8][size=8]", Txt.input(props.password))), m("p", m("label.medium[for=entry_csid]", "希望する配役"), m("select#entry_csid", Txt.input(props.csid_cid), f.csid_cids)), m("p", m("label.medium[for=entry_role]", "希望する役職"), m("select#entry_role", Txt.input(props.role), f.roles)), m("div", f.is_preview() ? (doc.ext.talk_name(null, f.chr_job.job + " " + f.chr_job.face.name), doc.ext.talk_text(null, props.style(), f.log().deco_preview), m("h6", "参加する時のセリフ")) : (m("textarea[cols=30][rows=" + f.lines + "]", Txt.input(f.log)), m("h6", "参加する時のセリフ"), m(".mark", f.errors))), m("p", f.is_preview() ? (m("a.btn", Btn.bool(f.is_preview), "戻る"), m("a.btn", submit(props, f), f.title), f.count, m("select.small", Txt.input(props.style), f.styles)) : (m("a.btn", Btn.bool(f.is_preview), f.title), f.count, m("select.small", Txt.input(props.style), f.styles))), m("p", f.label, m("span." + f.error, f.valid_text), !f.is_preview() ? m("span", f.diary) : void 0))))));
    },
    memo: function(f, props) {
      return m("form[name=memo_form]", m("table." + f.mestype + ".memo", {
        key: f._id
      }, m("tr", m("th", GUI.portrate(f.chr_job.face_id), m("div", m("b", f.chr_job.job + " " + f.chr_job.face.name))), m("td", f.is_preview() ? (doc.ext.talk_text(props.style(), f.log().deco_preview), m("h6", "参加する時のセリフ")) : (m("textarea[cols=30][rows=" + f.lines + "]", Txt.input(f.log)), m("h6", "参加する時のセリフ"), m(".mark", f.errors)), m("p", f.is_preview() ? (m("a.btn", Btn.bool(f.is_preview), "戻る"), m("a.btn", submit(props, f), f.title), f.count, m("select.small", Txt.input(props.style), f.styles)) : (m("a.btn", Btn.bool(f.is_preview), f.title), f.count, m("select.small", Txt.input(props.style), f.styles))), m("p", f.label, m("span." + f.error, f.valid_text), !f.is_preview() ? m("span", f.diary) : void 0)))));
    },
...
(function() {
  var Input, InputTie, Tie, _, bigicon, btn_attr, btn_item, btn_pick, c_icon, c_tap, change_attr, checkbox, checkbox_btn, checkbox_multi_item, custom_validity, debounce, e_checked, e_selected, e_value, form_attr, h_header, h_label, icon, icon_item, input, input_attr, input_pick, labeler, m, menuicon, mithril_config, option_attr, option_pick, radio_item, select, select_btn, select_multi, select_multi_btn, submit_btn, submit_form, textarea, validity_attr,
    slice = [].slice;
  ...
  icon_item = function(params, btn, o) {
    return function(value, m_attr) {
      ...
      return icon[tag](value, ma, option);
    };
  };
  ...
  radio_item = function(params, change, o) {
    return function(value, m_attr) {
      var _id, attr, ma, now_val, option, options, type, uri, val;
      if (m_attr == null) {
        m_attr = {};
      }
  ...
  checkbox_btn = function(params, btn, o) {
    return function(m_attr) {
      var _id, attr, ma, name, now_val;
      if (m_attr == null) {
        m_attr = {};
      }
      _id = o._id, name = o.name, attr = o.attr;
      now_val = params[_id];
  ...
  checkbox = function(params, change, o) {
    return function(m_attr) {
      var _id, attr, ma, now_val, type, uri, val;
      if (m_attr == null) {
        m_attr = {};
      }
      _id = o._id, type = o.type, attr = o.attr;
      now_val = params[_id];
      val = Mem.unpack[type];
      uri = Mem.pack[type];
  ...
  select_multi_btn = function(params, btn, o) {
    return function(m_attr) {
      var _id, attr, label, ma, now_vals, option, options, results, value;
      if (m_attr == null) {
        m_attr = {};
      }
      _id = o._id, options = o.options, attr = o.attr;
  ...
  select_multi = function(params, change, o) {
    var option_call;
    option_call = option_attr();
    return function(m_attr) {
      var _id, attr, current, ma, name, now_vals, option, options, type, uri, val, value;
      if (m_attr == null) {
        m_attr = {};
      }
      _id = o._id, type = o.type, name = o.name, options = o.options, current = o.current, attr = o.attr;
      now_vals = params[_id];
      val = Mem.unpack[type];
      uri = Mem.pack[type];
      return m('select', change(), (function() {
        var results;
        results = [];
        for (value in options) {
          option = options[value];
  ...
  select_btn = function(params, btn, o) {
    return function(m_attr) {
      var _id, attr, current, label, list, ma, now_val, option, options, value;
      if (m_attr == null) {
        m_attr = {};
      }
      _id = o._id, options = o.options, current = o.current, attr = o.attr;
      now_val = params[_id];
      list = (function() {
        var results;
        results = [];
  ...
  select = function(params, change, o) {
    var option_call;
    option_call = option_attr();
    return function(m_attr) {
      var _id, attr, current, label, list, ma, name, now_val, option, options, type, uri, val, value;
      if (m_attr == null) {
        m_attr = {};
      }
      _id = o._id, type = o.type, name = o.name, options = o.options, current = o.current, attr = o.attr;
  ...
  textarea = function(params, area, o) {
    return function(m_attr) {
      var _id, attr, ma, now_val;
      if (m_attr == null) {
        m_attr = {};
  ...
  change_attr = function(val, tie, b) {
    return function() {
      var _id, attrs, ma;
      _id = arguments[0], attrs = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      return ma = input_pick(attrs, {
        ...
        onchange: function(e) {
          return tie.do_change(_id, val(e), ma);
        },
        oninvalid: function(e) {
          return tie.do_fail(_id, val(e), ma);
        }
      });
    };
  };

  input_attr = function(val, tie, b) {
    return function() {
      var _id, attrs, ma;
      _id = arguments[0], attrs = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      return ma = input_pick(attrs, {
  ...
  btn_attr = function(val, tie, b) {
    return function() {
      var _id, attr, attrs, className, css, disabled, i, ma, o, onchange, selected, value;
      _id = arguments[0], attrs = 3 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 1, []), o = arguments[i++];
      className = o.className, disabled = o.disabled, selected = o.selected, value = o.value, attr = o.attr;
      onchange = function() {
        if (b.timer) {
          return;
        }
        debounce(b)["catch"](function() {
          return b.timer = null;
        });
        return tie.do_change(_id, val(selected, value), ma);
      };
      css = "btn";
  ...
  debounce = function(o) {
    o.timer = true;
    return new Promise(function(_, ng) {
      return o.timer = setTimeout(function() {
        return ng("reset " + o.timeout + "ms ");
      }, o.timeout);
    });
  };

  InputTie = (function() {
    InputTie.prototype.did_view = function(id, elem) {
      if (id) {
        return this.input[id].do_view(null, null);
      } else {
    ...
    InputTie.prototype.do_change = function(id, value, attr) {
      if (this.params[id] === value) {
        this.stay(id, value);
      } else {
        this.change(id, value, this.params[id]);
        this.params[id] = value;
      }
      this.input[id].do_change(value, attr);
      this.validate(this.input[id], value, attr);
    ...
    InputTie.prototype.validate = function(input, value, attr) {};
    ...
    InputTie.prototype.submit_for = function(attr) {
      if (this.form) {
        return submit_form(this, attr);
      } else {
        return submit_btn(this, attr);
      }
    };

    InputTie.prototype.input_for = function(options) {
    ...
    function InputTie(arg) {
      ...
      this.off();
      this.input = {};
      this.tie = Tie.build_input(ids, this.params, this, Input);
    ...
    InputTie.form = function(params, ids) {
      ...
      return new InputTie({
        ...
        form: function() {
          ...
          return m("form", form_attr(this, attr), vdom);
        }
      });
    };
  ...
  Input = (function() {
    Input.prototype.do_view = function(dom1) {
      this.dom = dom1;
    };
    ...
    Input.prototype.info = function(info_msg1) {
    ...
    function Input(tie, format) {
      ...
      this.label = labeler(params, format);
      this.head = h_label(params, format);
      now_val = function() {
        return tie.params[format._id];
      };
      switch (format.attr.type) {
        case "icon":
          btn = btn_attr(c_icon, tie, this);
          this.head = h_header(params, format);
          this.item = icon_item(params, btn, format);
          break;
        case "btns":
          btn = btn_attr(c_tap, tie, this);
          this.head = h_header(params, format);
          this.item = btn_item(params, btn, format);
          if (format.attr.multiple) {
            this.field = select_multi_btn(params, btn, format);
          } else {
            this.field = select_btn(params, btn, format);
          }
          break;
        case "checkbox_btn":
          btn = btn_attr(c_tap, tie, this);
          this.head = h_header(params, format);
          this.field = checkbox_btn(params, btn, format);
          break;
        case "select":
          if (format.attr.multiple) {
            attr = change_attr(e_selected, tie, this);
            this.field = select_multi(params, attr, format);
          } else {
            attr = change_attr(e_value, tie, this);
            this.field = select(params, attr, format);
          }
          break;
        case "radio":
          attr = change_attr(e_value, tie, this);
          this.item = radio_item(params, attr, format);
          break;
        case "checkbox":
          attr = change_attr(e_checked, tie, this);
          this.field = checkbox(params, attr, format);
          break;
        case "textarea":
          attr = input_attr(e_value, tie, this);
          this.field = textarea(params, attr, format);
          break;
        default:
          attr = input_attr(e_value, tie, this);
          this.field = input(params, attr, format);
      }
    }

    Input.timeout = 1000;

    Input.format = function(o) {
      var _id, base, base1, label, ref, ref1;
      if (o.label == null) {
        o.label = {};
      }
      ...
      for (_id in ref1) {
        ...
        o.options[_id] = "object" === typeof label ? (label._id = _id, label) : {
          _id: _id,
          label: label
        };
      }
...
},{"./tie":19,"lodash":4,"mithril":8}],18:[function(require,module,exports){
(function() {
  ...
  build = function(key, o, cb) {
    var i, len, results, results1, subkey, val;
    switch (type(o)) {
      case "Array":
        results = [];
      ...
      case "Object":
        ...
        for (subkey in o) {
          ...
          results1.push(cb("" + key + subkey, val));
        }
        return results1;
        break;
      case "Function":
  ...
  module.exports = Submit = {
    get: function(base_url, params) {
      var deserialize, key, method, query_array, url, val;
      query_array = ["?"];
      for (key in params) {
        val = params[key];
    ...
    iframe: function(url, params) {
      return new Promise(function(ok, ng) {
        ...
        auto_load = {
          ...
          config: function(iframe) {
            ...
            timer = setTimeout(function() {
              return ng(new Error("form request time out."));
            }, 10000);
            ...
            return iframe.onload = function() {
              ...
              try {
                clearTimeout(timer);
                return ok(Mem.unpack.HtmlGon(iframe.contentDocument.body.innerHTML));
              } catch (error) {
                e = error;
                return ng(e);
              } finally {
        ...
        m.startComputation();
        return m.render(iframe_handler, [
          m('iframe', auto_load), m('form#submit_request', auto_submit, build("", params, function(key, val) {
            return m('input', {
              type: "hidden",
              name: key,
              value: val
...
(function() {
  ...
  Tie = (function() {
    ...
    Tie.build_input = function(ids, params, inputTie, Input) {
      var i, len, o, ref, tie;
      if (ids == null) {
        ids = [];
      }
      tie = new Tie;
      ref = Mem.Query.inputs.where({
        _id: ids
      }).list;
      for (i = 0, len = ref.length; i < len; i++) {
        o = ref[i];
    ...
    Tie.prototype.deploy = function(define, params, o) {
      var _id, current, pack, type, unpack, val;
      if (o.current == null) {
        o.current = null;
      }
      _id = o._id, current = o.current, type = o.type;
...
},{"memory-record":5}],20:[function(require,module,exports){
(function() {
  var Timer, _;
  ...
  Timer = (function() {
    ...
    Timer.fetch = function(at) {
      var base;
      return (base = Timer.cache)[at] != null ? base[at] : base[at] = new Timer(at);
    };
...
},{"lodash":4}],21:[function(require,module,exports){
(function() {
...
},{"./tie":19,"lodash":4,"memory-record":5}],22:[function(require,module,exports){
(function() {
