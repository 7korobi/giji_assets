    ...
    search: {
      ...
      scroll: new Url("scr=:scroll~:talk_at~:memo_at", {
        ...
        change: function(params) {
          ...
          if (logid != null) {
            updated_at = ((ref1 = Mem.Query.messages.find(scroll)) != null ? ref1.updated_at : void 0) || 0;
...
(function() {
  ...
  Mem.Collection.item.set([
    {
      ...
      "name": "ティモシー",
      "updated_at": 1437461000000,
      "log": "（↓）をそっと畳み、営業を再開した。<br><a href=\"http://crazy-crazy.sakura.ne.jp/giji/\"><img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/banner/guide.png\"></a>"
    }, {
      ...
      "updated_at": 1437461000000,
      "style": "head",
      "log": "<a class=\"btn edge\" href=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/assets-master/rule.html?scr=nation~~\">ルール</a>\nと\n<a class=\"btn edge\" href=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/assets-master/rule.html?scr=player~~\">心構え</a>\nを守って、楽しく、強く遊ぼう。\n<br>\nここでは、みんなに守ってほしいルールや、吟味してほしい心構えを紹介するよ。\n<br>\nでは、リンク先の１ページ目から―――"
    }, {
      "_id": "title-head-h6-13",
      "log": "キャラクター画像一覧"
    }, {
      "_id": "title-paragraph--14",
      "log": "<a class=\"btn edge\" href=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/assets-master/character_tag.html\">キャラクター画像はこちら</a>\nキャラクターを選ぶ参考に、<a class=\"btn edge\" href=\"http://giji.f5.si/map_reduce/faces\">人気度集計</a>をチェックしてもいいかもね。"
    }, {
      ...
      "log": "<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/key.png\">\nマークの付いた村は、参加にパスワードが必要です。\n<br>\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_love.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_sexy.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_violence.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_teller.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_drunk.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_gamble.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_crime.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_drug.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_word.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_fireplace.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_appare.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_ukkari.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_child.png\">\n<img src=\"http://s3-ap-northeast-1.amazonaws.com/giji-assets/images/icon/cd_biohazard.png\">\nマークは、<a class=\"btn edge\" href=\"http://crazy-crazy.sakura.ne.jp/giji/?(Knowledge)Manual#mark\">こだわり</a>のある村についています。まず村の情報をよく読んで、好みのあう村を選びましょう。"
    }, {
  ...
  deploy_samples = function() {
    ...
    deploy = function(role, call) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        if (able !== "vote" && able !== "entrust") {
          is_main || (is_main = Mem.Query.ables.find(able).at.main);
        }
      }
      if (is_main) {
        turns = ["main"];
    ...
    for (k = 0, len2 = ref2.length; k < len2; k++) {
      rolename = ref2[k];
      if (role = Mem.Query.roles.find(rolename)) {
        deploy(role, function(turn) {
          return {
            mob: "visiter",
            enemy: "evil",
    ...
    forms = Mem.Query.items.where({
      template: "form"
    }).list;
    Mem.Collection.story.set([
      {
        "_id": "morphe-126",
        "folder": "MORPHE",
        "is_epilogue": true,
    ...
    Mem.Collection.event.set([
      {
        "story_id": "morphe-126",
        "turn": 9
      }
    ]);
    Mem.Collection.potof.set([
      {
        "bonds": [],
        "clearance": 1,
        "csid": "all",
    ...
    return Mem.Collection.form.set(forms);
  };
...
(function(){
  doc.config = function(xhr, options){
    console.log(options);
    return xhr.overrideMimeType("text/plain; charset=Shift_JIS");
  };
}).call(this);
...
(function(){
  ...
  menu = {
    ...
    view: function(){
      var event, role;
      return m(".SAY.paragraph", doc.timeline(), m("h6", "あなたが書き込む内容です。 - 記述"), (event = Mem.Query.events.list.last()) ? (function(){
        var i$, ref$, len$, results$ = [];
...
(function() {
  win.mount("#css_changer", function(dom) {
    return {
      controller: function() {
        var ref;
        this.url = (ref = window.gon) != null ? ref.url : void 0;
      },
